...
if [ -f "$FILE" ]; then
    ...
    ln -s /var/toltek/Toltek.Blue.Api/toltek.blue.api.service /etc/systemd/system/toltek.blue.api.service

    rm /usr/share/bigbluebutton/nginx/toltek.blue.api.nginx
    ln -s /var/toltek/Toltek.Blue.Api/toltek.blue.api.nginx /usr/share/bigbluebutton/nginx/toltek.blue.api.nginx
